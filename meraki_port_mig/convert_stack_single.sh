...
if [[ "$CONFIG1" == "/root/.meraki_port_mig/tmp/switch1.txt" && "$SERIAL1" == "/root/.meraki_port_mig/tmp/serial1.txt" ]]; then
    ...
    mv /root/.meraki_port_mig/tmp/switch1.txt /root/.meraki_port_mig/cisco_config.tmp
    mv /root/.meraki_port_mig/tmp/serial1.txt /root/.meraki_port_mig/serial.txt
    python3.10 /root/.meraki_port_mig/port_migration.py
#    cat /var/lib/tftpboot/port_switch/${IP}-shmr | grep C9300 |grep -E -o "Q.{0,13}" >> /root/.meraki_port_mig/serial.tmp
#    sed -n '1p' "/root/.meraki_port_mig/serial.tmp" >> "/root/.meraki_port_mig/serial.txt"
    else
    echo " "
fi
...
if [[ "$CONFIG2" == "/root/.meraki_port_mig/tmp/switch2.txt" && "$SERIAL2" == "/root/.meraki_port_mig/tmp/serial2.txt" ]]; then
    ...
    mv /root/.meraki_port_mig/tmp/switch2.txt /root/.meraki_port_mig/cisco_config.tmp
    mv /root/.meraki_port_mig/tmp/serial2.txt /root/.meraki_port_mig/serial.txt
    python3.10 /root/.meraki_port_mig/port_migration.py
#    cat /var/lib/tftpboot/port_switch/${IP}-shmr | grep C9300 |grep -E -o "Q.{0,13}" >> /root/.meraki_port_mig/serial.tmp
#    sed -n '1p' "/root/.meraki_port_mig/serial.tmp" >> "/root/.meraki_port_mig/serial.txt"
    else
...
if [[ "$CONFIG3" == "/root/.meraki_port_mig/tmp/switch3.txt" && "$SERIAL3" == "/root/.meraki_port_mig/tmp/serial3.txt" ]]; then
    ...
    mv /root/.meraki_port_mig/tmp/switch3.txt /root/.meraki_port_mig/cisco_config.tmp
    mv /root/.meraki_port_mig/tmp/serial3.txt /root/.meraki_port_mig/serial.txt
    python3.10 /root/.meraki_port_mig/port_migration.py
#    cat /var/lib/tftpboot/port_switch/${IP}-shmr | grep C9300 |grep -E -o "Q.{0,13}" >> /root/.meraki_port_mig/serial.tmp
#    sed -n '1p' "/root/.meraki_port_mig/serial.tmp" >> "/root/.meraki_port_mig/serial.txt"
    else
...
if [[ "$CONFIG4" == "/root/.meraki_port_mig/tmp/switch4.txt" && "$SERIAL4" == "/root/.meraki_port_mig/tmp/serial4.txt" ]]; then
    ...
    mv /root/.meraki_port_mig/tmp/switch4.txt /root/.meraki_port_mig/cisco_config.tmp
    mv /root/.meraki_port_mig/tmp/serial4.txt /root/.meraki_port_mig/serial.txt
    python3.10 /root/.meraki_port_mig/port_migration.py
#    cat /var/lib/tftpboot/port_switch/${IP}-shmr | grep C9300 |grep -E -o "Q.{0,13}" >> /root/.meraki_port_mig/serial.tmp
#    sed -n '1p' "/root/.meraki_port_mig/serial.tmp" >> "/root/.meraki_port_mig/serial.txt"
    else
...
if [[ "$CONFIG5" == "/root/.meraki_port_mig/tmp/switch5.txt" && "$SERIAL5" == "/root/.meraki_port_mig/tmp/serial5.txt" ]]; then
    ...
    mv /root/.meraki_port_mig/tmp/switch5.txt /root/.meraki_port_mig/cisco_config.tmp
    mv /root/.meraki_port_mig/tmp/serial5.txt /root/.meraki_port_mig/serial.txt
    python3.10 /root/.meraki_port_mig/port_migration.py
#    cat /var/lib/tftpboot/port_switch/${IP}-shmr | grep C9300 |grep -E -o "Q.{0,13}" >> /root/.meraki_port_mig/serial.tmp
#    sed -n '1p' "/root/.meraki_port_mig/serial.tmp" >> "/root/.meraki_port_mig/serial.txt"
    else
...
if [[ "$CONFIG6" == "/root/.meraki_port_mig/tmp/switch6.txt" && "$SERIAL6" == "/root/.meraki_port_mig/tmp/serial6.txt" ]]; then
    ...
    mv /root/.meraki_port_mig/tmp/switch6.txt /root/.meraki_port_mig/cisco_config.tmp
    mv /root/.meraki_port_mig/tmp/serial6.txt /root/.meraki_port_mig/serial.txt
    python3.10 /root/.meraki_port_mig/port_migration.py
#    cat /var/lib/tftpboot/port_switch/${IP}-shmr | grep C9300 |grep -E -o "Q.{0,13}" >> /root/.meraki_port_mig/serial.tmp
#    sed -n '1p' "/root/.meraki_port_mig/serial.tmp" >> "/root/.meraki_port_mig/serial.txt"
    else
...
if [[ "$CONFIG7" == "/root/.meraki_port_mig/tmp/switch7.txt" && "$SERIAL7" == "/root/.meraki_port_mig/tmp/serial7.txt" ]]; then
    ...
    mv /root/.meraki_port_mig/tmp/switch7.txt /root/.meraki_port_mig/cisco_config.tmp
    mv /root/.meraki_port_mig/tmp/serial7.txt /root/.meraki_port_mig/serial.txt
    python3.10 /root/.meraki_port_mig/port_migration.py
#    cat /var/lib/tftpboot/port_switch/${IP}-shmr | grep C9300 |grep -E -o "Q.{0,13}" >> /root/.meraki_port_mig/serial.tmp
#    sed -n '1p' "/root/.meraki_port_mig/serial.tmp" >> "/root/.meraki_port_mig/serial.txt"
    else
...
if [[ "$CONFIG8" == "/root/.meraki_port_mig/tmp/switch8.txt" && "$SERIAL8" == "/root/.meraki_port_mig/tmp/serial8.txt" ]]; then
    ...
    mv /root/.meraki_port_mig/tmp/switch8.txt /root/.meraki_port_mig/cisco_config.tmp
    mv /root/.meraki_port_mig/tmp/serial8.txt /root/.meraki_port_mig/serial.txt
    python3.10 /root/.meraki_port_mig/port_migration.py
#    cat /var/lib/tftpboot/port_switch/${IP}-shmr | grep C9300 |grep -E -o "Q.{0,13}" >> /root/.meraki_port_mig/serial.tmp
#    sed -n '1p' "/root/.meraki_port_mig/serial.tmp" >> "/root/.meraki_port_mig/serial.txt"
    else
