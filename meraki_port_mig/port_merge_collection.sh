...
sed -i '6i DISCOVERED DEVICES,IP_ADDRESS,SWITCH_NUMBER,' /root/.meraki_port_mig/tmp/layout
sed -i '7i EXAMPLE,192.168.1.1,1,' /root/.meraki_port_mig/tmp/layout
sed -i '8i ,192.168.1.1,2,' /root/.meraki_port_mig/tmp/layout
sed -i '9i ,192.168.1.1,3,' /root/.meraki_port_mig/tmp/layout
sed -i '10i ,192.168.1.1,4,' /root/.meraki_port_mig/tmp/layout
