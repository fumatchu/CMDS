...
while choice=$(dialog --title "$TITLE" \
 ...
 11) clear & /root/.meraki_port_mig/batch_clean.sh ;;
 12) clear & /root/.meraki_port_mig/.logo ;;
 13) clear & /root/.meraki_port_mig/global_environment.sh ;;
 14) clear & /root/.meraki_port_mig/schedule.sh ;;
 15) clear & /root/.meraki_port_mig/logging_environment.sh ;;
 16) clear & /root/.meraki_port_mig/utilities.sh ;;
 17) clear & /root/.meraki_port_mig/welcome.readme | more ;;
  esac
done
