...
def main():
    ...
    # Port IDs of the MA-MOD-2X40 ports to update (assuming ports 1 to 2)
    uplink_ports = [
        "1_MA-MOD-2X40G_1",
        "1_MA-MOD-2X40G_2",
    ]
    ...
    for interface, config in interfaces.items():
        ...
        if port_match:
            ...
            port_id = f"1_MA-MOD-2X40G_{port_split}"
            if port_id in uplink_ports:
                ...
                print(
                    f"Interface {interface} does not match any of the MA-MOD-40G ports."
                )
        else:
