...
#What model is the Switch?
  MODEL9300=$(cat /var/lib/tftpboot/mig_switch/nwd-${IP}-shver | grep "Model Number" | grep C9300 | tr -cd 'C9300')
  MODEL9300L=$(cat /var/lib/tftpboot/mig_switch/nwd-${IP}-shver | grep "Model Number" | grep C9300L | tr -cd 'C9300L')
