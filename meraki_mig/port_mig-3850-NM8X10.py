...
def main():
    ...
    # Port IDs of the 3850-NM-8X10 ports to update (assuming ports 1 to 8)
    uplink_ports = [
        "1_C3850-NM-8-10G_1",
        "1_C3850-NM-8-10G_2",
        "1_C3850-NM-8-10G_3",
    ...
    for interface, config in interfaces.items():
        ...
        if port_match:
            ...
            port_id = f"1_C3850-NM-8-10G_{port_split}"
            if port_id in uplink_ports:
                ...
                print(
                    f"Interface {interface} does not match any of the C3850-NM-8-10G ports."
                )
        else:
