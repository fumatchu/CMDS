...
def main():
    ...
    # Port IDs of the MA-MOD4X10G ports to update (assuming ports 1 to 4)
    uplink_ports = [
        "1_MA-MOD-4X10G_1",
        "1_MA-MOD-4X10G_2",
        "1_MA-MOD-4X10G_3",
    ...
    for interface, config in interfaces.items():
        ...
        if port_match:
            ...
            port_id = f"1_MA-MOD-4X10G_{port_split}"
            if port_id in uplink_ports:
                ...
                print(
                    f"Interface {interface} does not match any of the MA-MOD-10G ports."
                )
        else:
