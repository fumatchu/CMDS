...
def main():
    ...
    # Port IDs of the 1_C9300-NM-4G ports to update (assuming ports 1 to 4)
    uplink_ports = [
        "1_C9300-NM-4G_1",
        "1_C9300-NM-4G_2",
        "1_C9300-NM-4G_3",
    ...
    for interface, config in interfaces.items():
        ...
        if port_match:
            ...
            port_id = f"1_C9300-NM-4G_{port_split}"
            if port_id in uplink_ports:
                ...
                print(
                    f"Interface {interface} does not match any of the C9300-NM-4G ports."
                )
        else:
