...
def main():
    ...
    # Port IDs of the C9300-NM-2Y ports to update (assuming ports 1 to 2)
    uplink_ports = [
        "1_C9300-NM-2Y_1",
        "1_C9300-NM-2Y_2",
    ]
    ...
    for interface, config in interfaces.items():
        ...
        if port_match:
            ...
            port_id = f"1_C9300-NM-2Y_{port_split}"
            if port_id in uplink_ports:
                ...
                print(
                    f"Interface {interface} does not match any of the C9300-NM-2Y ports."
                )
        else:
