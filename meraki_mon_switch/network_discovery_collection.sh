...
#What model is the Switch?
  MODEL9200=$(cat /var/lib/tftpboot/mon_switch/nwd-${IP}-shver | grep "Model Number" | grep C9200 -Eo | grep C9200 -m 1)
  MODEL9200L=$(cat /var/lib/tftpboot/mon_switch/nwd-${IP}-shver | grep "Model Number" | grep C9200L -Eo | grep C9200 -m 1)
...
#What model is the Switch?
  MODEL9300=$(cat /var/lib/tftpboot/mon_switch/nwd-${IP}-shver | grep "Model Number" | grep C9300 -Eo | grep C9300 -m 1)
  MODEL9300L=$(cat /var/lib/tftpboot/mon_switch/nwd-${IP}-shver | grep "Model Number" | grep C9300L -Eo | grep C9300 -m 1)
...
#What model is the Switch?
  MODEL9500=$(cat /var/lib/tftpboot/mon_switch/nwd-${IP}-shver | grep "cisco C9500" | grep C9500 -Eo | grep C9500 -m 1)
